...
.data
	...
	caracteresLetrNUm 		db	30h,31h,32h,33h,34h,35h,36h,37h,38h,39h,41h,42h,43h,44h,45h,46h,47h,48h,49h,4ah
							...
							db	65h,66h,67h,68h,69h,6ah,6bh,6ch,6dh,6eh,6fh,71h,72h,73h,74h,75h,76h,77h,78h,79h,7ah
...
.code
	...
	;║║		║║								║║				║║
	;║║ 13. ║║	  COLOCAR MAYUSCULAS    -->>║║	linea 416	║║
	 ║║		║║	public						║║				║║
	;║║		║║								║║				║║
	;║║ 13. ║║							-->>║║	linea 416	║║
	 ║║		║║	public						║║				║║
...
;||04||==FUNCION==PARA==CARGAR==SOLO==CARACTERES==Y==NUMEROS======================================================================================
;
	cargaNumericaf proc
...
;||013||==FUNCION==PARA==COLOCAR==MAYUSCULAS===========================================================================================
;
